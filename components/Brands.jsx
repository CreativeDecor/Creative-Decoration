...
const brands = [
  { id: 'decor', name: "D'Decor", tagline: 'Fabrics & Drapes', logo: '/images/brands/decor.png' },
  { id: 'fabio', name: 'Fabio Furnishings', tagline: 'Premium Sofas', logo: '/images/brands/fabio.png' },
  { id: 'somfy', name: 'Somfy', tagline: 'Smart Blinds', logo: '/images/brands/somfy.png' },
  { id: 'welspun', name: 'Welspun', tagline: 'Home Textiles', logo: '/images/brands/welspun.png' },
  { id: 'obsessions', name: 'Obsessions', tagline: 'Wall Décor', logo: '/images/brands/obesssion.png' },
];
